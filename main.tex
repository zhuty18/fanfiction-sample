...
\textbackslash bleed，启用代表增设出血（上下左右各3mm），禁用则代表按A5（148*210mm）输出\textbf{效果图}，不适宜直接用于打印。

\chapter{进阶设置}

本文的字体全部配置在font.tex文件中；格式全部设定在formats.tex文件中。如果对某处设定不满意的话，可以自行修改模板。

模版中有一些注释，但不是很全面。如果有地方不能理解，或者需要其他的功能，推荐阅读我写的这篇\href{https://zhuty18.github.io/docs/%E5%90%8C%E4%BA%BA%E6%96%87%E6%9C%ACLaTeX%E6%8E%92%E7%89%88%E6%95%99%E7%A8%8B}{\underline{排版教程}}。这个教程随时可能进行调整和补充。由于内容不断变化，就不放在这里了。
...
由于目前没有中英文混合的Lorem Ipsum包\footnote{对此深感遗憾}可用，直接引用了一篇科普来作为中英文混合的内容填充样例\endnote{本文来源于\href{https://cn.lipsum.com/}{\underline{https://cn.lipsum.com/}}}。
